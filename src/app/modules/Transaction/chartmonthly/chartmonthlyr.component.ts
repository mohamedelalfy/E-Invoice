...
@Component({
  selector: 'app-chartmonthlyr',
  templateUrl: './chartmonthlyr.component.html',
  styleUrls: ['./chartmonthlyr.component.css']
})
export class ChartmonthlyrComponent implements OnInit {
